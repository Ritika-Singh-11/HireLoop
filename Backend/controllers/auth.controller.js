  ...
  try {
    ...
    if (role === 'student') {
      ...
      await RecruiterProfile.create({
        ...
        // NOTE: industry/website aren't in the RecruiterProfile schema yet.
        // Add them there if you want to persist them — harmless to receive
        // and ignore them here in the meantime.
      });
    }
